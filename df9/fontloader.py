...
class FontLoader(object):
    ...
    def __init__(self):
        ...
        self._cairo_so.cairo_ft_font_face_create_for_ft_face.argtypes = [
    ...
    def cairo_font_face_from_file(self, filename, faceindex=0, loadoptions=0):
        ...
        if FT_ERR_OK != self._freetype_so.FT_New_Face(
                self._ft_lib, filename, faceindex, ctypes.byref(ft_face)
        ):
